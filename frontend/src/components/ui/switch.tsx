...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      // Checked state - primary color with border
      'data-[state=checked]:bg-primary-500 data-[state=checked]:border-primary-600',
      // Unchecked state - more visible with border and background
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        'data-[state=unchecked]:translate-x-0.5 data-[state=unchecked]:bg-foreground-muted'
      )}
    />
  </SwitchPrimitives.Root>
));
